...
PParseResult PProtoParser::parseStrlist(const char*& ptr, const char* end, std::vector<std::string>& results) {
...
PParseResult PProtoParser::parseStr(const char*& ptr, const char* end, std::string& result) {
  if (paramLen_ == -1) {
...
PParseResult PProtoParser::parseStrval(const char*& ptr, const char* end, std::string& result) {
  assert(paramLen_ >= 0);

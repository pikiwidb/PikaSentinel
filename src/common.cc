...
size_t FormatSingle(const std::string& str, UnboundedBuffer* reply) { return FormatSingle(str.c_str(), str.size(), reply); }
...
size_t FormatBulk(const std::string& str, UnboundedBuffer* reply) { return FormatBulk(str.c_str(), str.size(), reply); }
